...
Code for **Moonstone: A Multimodal Foundation Model and Benchmark for Lunar
Remote Sensing**, accepted for publication at ECCV 2026. This repository contains
...
**https://huggingface.co/datasets/ayushprd/Moonstone**, split into a
`pretraining/` part (z-scored memory-mapped arrays + source GeoTIFFs) and a
`benchmark/` part (`lunar_patches_v4.h5` + label rasters).
...
Please cite the Moonstone paper if you use this dataset, model, or benchmark.
